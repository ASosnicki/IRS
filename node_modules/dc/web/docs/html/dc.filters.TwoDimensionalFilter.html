...
<dd>
    ...
    <div class="description">
        <p>TwoDimensionalFilter is a filter which accepts a single two-dimensional value.  It is used by the<br><a href="dc.heatMap.html">heat map chart</a> to include particular cells as they are clicked.  (Rows and columns are<br>filtered by filtering all the cells in the row or column.)</p>
