...
<head>
	...
	<title>dc.js Class: RangedFilter</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: RangedFilter</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="RangedFilter"><span class="type-signature"></span>new RangedFilter(low, high)</h4>
...
<dd>
    ...
    <div class="description">
        <p>RangedFilter is a filter which accepts keys between <code>low</code> and <code>high</code>.  It is used to implement X<br>axis brushing for the <a href="dc.coordinateGridMixin.html">coordinate grid charts</a>.</p>
<p>Its <code>filterType</code> is 'RangedFilter'</p>
    </div>
		...
		<ul class="dummy">
			<li>
				<a href="filters.js.html">filters.js</a>,
				 <a href="filters.js.html#sunlight-1-line-23">line 23</a>
			</li>
		</ul>
	</dd>
