...
<article>
    <div class="container-overview">
            ...
            <div class="description"><p>Cap is a mixin that groups small data elements below a <em>cap</em> into an <em>others</em> grouping for both the<br>Row and Pie Charts.</p>
<p>The top ordered elements in the group up to the cap amount will be kept in the chart, and the rest<br>will be replaced with an <em>others</em> element, with value equal to the sum of the replaced values. The<br>keys of the elements below the cap limit are recorded in order to filter by those keys when the<br>others* element is clicked.</p></div>
...
<hr>
<dt>
    <h4 class="name" id="cap"><span class="type-signature"></span>cap(<span class="optional">count</span>)</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="cap-mixin.js.html">cap-mixin.js</a>,
				 <a href="cap-mixin.js.html#sunlight-1-line-62">line 62</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="othersGrouper"><span class="type-signature"></span>othersGrouper(<span class="optional">grouperFunction</span>)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Get or set the grouper function that will perform the insertion of data for the <em>Others</em> slice<br>if the slices cap is specified. If set to a falsy value, no others will be added. By default the<br>grouper function computes the sum of all values below the cap.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="cap-mixin.js.html">cap-mixin.js</a>,
				 <a href="cap-mixin.js.html#sunlight-1-line-96">line 96</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type"><a href="dc.capMixin.html">dc.capMixin</a></span>
    ...
    <pre class="sunlight-highlight-javascript">// Default others grouper
...
<hr>
<dt>
    <h4 class="name" id="othersLabel"><span class="type-signature"></span>othersLabel(<span class="optional">label</span>)</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="cap-mixin.js.html">cap-mixin.js</a>,
				 <a href="cap-mixin.js.html#sunlight-1-line-79">line 79</a>
			</li>
		</ul>
	</dd>
