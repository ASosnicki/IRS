...
<head>
	...
	<title>dc.js Namespace: units</title>
...
<div class="row">
	...
	<h1 class="page-title">Namespace: units</h1>
<section>
		...
		<ul class="dummy">
			<li>
				<a href="core.js.html">core.js</a>,
				 <a href="core.js.html#sunlight-1-line-313">line 313</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id=".integers"><span class="type-signature">&lt;static> </span>integers(start, end)</h4>
...
<dd>
    ...
    <div class="description">
        <p>The default value for <a href="dc.coordinateGridMixin.html#xUnits">.xUnits</a> for the<br><a href="dc.coordinateGridMixin.html">Coordinate Grid Chart</a> and should<br>be used when the x values are a sequence of integers.<br>It is a function that counts the number of integers in the range supplied in its start and end parameters.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core.js.html">core.js</a>,
				 <a href="core.js.html#sunlight-1-line-320">line 320</a>
			</li>
		</ul>
	</dd>
	...
	<dd class="tag-see">
		<ul>
			<li><a href="dc.coordinateGridMixin.html#xUnits">coordinateGridMixin.xUnits</a></li>
			</ul>
	</dd>
...
<span class="param-type">Number</span>
    ...
    <pre class="sunlight-highlight-javascript">chart.xUnits(dc.units.integers) // already the default</pre>
...
<hr>
<dt>
    <h4 class="name" id=".ordinal"><span class="type-signature">&lt;static> </span>ordinal(start, end, domain)</h4>
...
<dd>
    ...
    <div class="description">
        <p>This argument can be passed to the <a href="dc.coordinateGridMixin.html#xUnits">.xUnits</a> function of the to<br>specify ordinal units for the x axis. Usually this parameter is used in combination with passing<br><a href="https://github.com/mbostock/d3/wiki/Ordinal-Scales">d3.scale.ordinal</a> to<br><a href="dc.coordinateGridMixin.html#x">.x</a>.<br>It just returns the domain passed to it, which for ordinal charts is an array of all values.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core.js.html">core.js</a>,
				 <a href="core.js.html#sunlight-1-line-338">line 338</a>
			</li>
		</ul>
	</dd>
	...
	<dd class="tag-see">
		<ul>
			<li><a href="https://github.com/mbostock/d3/wiki/Ordinal-Scales">d3.scale.ordinal</a></li>
			
			<li><a href="dc.coordinateGridMixin.html#xUnits">coordinateGridMixin.xUnits</a></li>
			
			<li><a href="dc.coordinateGridMixin.html#x">coordinateGridMixin.x</a></li>
			</ul>
	</dd>
...
<span class="param-type">Array.&lt;String></span>
    ...
    <pre class="sunlight-highlight-javascript">chart.xUnits(dc.units.ordinal)
     .x(d3.scale.ordinal())</pre>
