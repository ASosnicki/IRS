...
<dd>
    ...
    <div class="description">
        <p>The RangedTwoDimensionalFilter allows filtering all values which fit within a rectangular<br>region. It is used by the <a href="dc.scatterPlot.html">scatter plot</a> to implement rectangular brushing.</p>
