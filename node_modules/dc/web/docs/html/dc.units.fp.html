...
<dd>
    ...
    <div class="description">
        <p>This function generates an argument for the <a href="dc.coordinateGridMixin.html">Coordinate Grid Chart</a><br><a href="dc.coordinateGridMixin.html#xUnits">.xUnits</a> function specifying that the x values are floating-point<br>numbers with the given precision.<br>The returned function determines how many values at the given precision will fit into the range<br>supplied in its start and end parameters.</p>
    </div>
